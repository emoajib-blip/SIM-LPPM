...
<head>
    ...
    <style>
        ...
        th { background-color: #f1f4f9; font-weight: bold; text-align: center; font-size: 8.5pt; color: #1a4a8e; }
        td { font-size: 8.5pt; }
            ...
            @forelse($proposals as $index => $proposal)
                <tr>
                    ...
                    <td class="text-center">
                        <span class="fw-bold" style="color: {{ $proposal->status?->value === 'approved' || $proposal->status?->value === 'completed' ? '#2d7a10' : '#444' }}">
