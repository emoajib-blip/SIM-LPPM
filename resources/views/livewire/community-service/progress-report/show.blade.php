                ...
                @if ($progressReport && $progressReport->hasMedia('substance_file'))
                    ...
                    <div class="alert alert-success mb-0 mt-2">
                        <div class="d-flex align-items-center justify-content-between">
                            ...
                            <a data-navigate-ignore="true" href="{{ URL::signedRoute('media.download', ['media' => $media]) }}" target="_blank" class="btn btn-sm btn-primary">
                                    ...
                                    <tr wire:key="wajib-row-{{ $output->id }}">
                                        ...
                                        <td>
                                            @if ($rowMandatoryOutput && $rowMandatoryOutput->hasMedia('journal_article'))
                                                ...
                                                @endphp
                                                <a data-navigate-ignore="true" href="{{ URL::signedRoute('media.download', ['media' => $media]) }}" target="_blank"
