...
<x-slot:pageSubtitle>
    Tinjau dan setujui laporan akhir penelitian dan pengabdian yang telah disetujui Dekan.
</x-slot:pageSubtitle>
                    ...
                    @empty
                        <tr>
                            <td colspan="5" class="py-8 text-center">
                                ...
                                <p class="text-secondary">Tidak ada laporan akhir yang menunggu persetujuan Anda.</p>
                            </td>
                        </tr>
                    @endforelse
                </tbody>
