...
<div>
    ...
    <div class="page-body">
        <div class="container-xl">
            ...
            <p class="text-secondary small mb-3">
                Berkas berikut digunakan saat dosen membuat laporan kemajuan dan akhir untuk penelitian ataupun pengabdian.
            </p>
                ...
                <div class="card-body">
                    <form wire:submit.prevent="saveApprovalSettings">
                        <div class="row">
                            <div class="col-md-6">
                                <div class="mb-3">
                                    <label class="form-label fw-semibold">Metode Persetujuan Proposal (Dekan & LPPM)</label>
                    ...
                    @if(in_array($report_approval_mode, ['upload', 'both']))
                        ...
                        <div class="row align-items-center">
                            <div class="col-md-5">
                                ...
                                <p class="text-secondary small mb-0">
                                    Unggah template Word/PDF kosong agar dosen dapat mengunduhnya saat menyusun laporan akhir.
                                </p>
                            </div>
                            <div class="col-md-7 mt-3 mt-md-0">
                                <form wire:submit.prevent="saveReportApprovalPageTemplate">
                                    <div class="input-group">
                                        <input type="file" class="form-control"
                                            wire:model="report_approval_page_template">
                                        <button type="submit" class="btn btn-azure" wire:loading.attr="disabled">
                                            Simpan
                                        </button>
                                    </div>
