            ...
            @foreach ($notes as $note)
                @if ($note->media->isNotEmpty())
                    <div style="margin-bottom: 30px; border: 1px solid #ccc; padding: 15px; page-break-inside: avoid;">
                        <div style="margin-top: 0; margin-bottom: 15px; border-bottom: 1px solid #eee; padding-bottom: 8px; font-weight: bold; font-size: 11pt;">
                        ...
                        @foreach ($note->media as $media)
                            <div style="margin-bottom: 20px; text-align: center;">
                                <div style="font-weight: bold; margin-bottom: 8px; font-size: 8pt; text-align: left; background: #f9f9f9; padding: 4px; border-left: 3px solid #ccc;">
                                ...
                                @if (str_starts_with($media->mime_type, 'image/'))
                                    ...
                                    @if(file_exists($imagePath))
                                        <img src="{{ $imagePath }}" style="max-width: 100%; max-height: 500px; display: block; margin: 0 auto; border: 1px solid #ddd; padding: 3px;">
                                    @else
                                ...
                                @else
                                    <div style="background: #f8f9fa; border: 1px dashed #aaa; padding: 20px; color: #555;">
                                        ...
                                        <small style="font-style: italic;">Sistem tidak dapat menempelkan file ini ke dalam lembar PDF. Harap ulik secara terpisah.</small>
                                    </div>
                                @endif
                            </div>
                        @endforeach
