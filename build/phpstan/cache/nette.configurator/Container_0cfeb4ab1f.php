...
class Container_0cfeb4ab1f extends _PHPStan_5930232b5\Nette\DI\Container
{
	protected $tags = [
	...
	public function createService0364(): PHPStan\File\FileExcluderRawFactory
	{
		return new class ($this) implements PHPStan\File\FileExcluderRawFactory {
			...
			public function __construct(Container_0cfeb4ab1f $container)
			{
	...
	public function createServiceContainer(): Container_0cfeb4ab1f
	{
		return $this;
	}
	...
	protected function getStaticParameters(): array
	{
		return [
			...
			'env' => [
				...
				'OLDPWD' => '/Volumes/WORK/PROJECT PROTOTYPE/sim-lppm-itsnu-main',
				...
				'_' => '/Volumes/WORK/PROJECT PROTOTYPE/sim-lppm-itsnu-main/vendor/bin/phpstan',
				'LINES' => '6',
				'COLUMNS' => '90',
				'SHELL_VERBOSITY' => '0',
			],
