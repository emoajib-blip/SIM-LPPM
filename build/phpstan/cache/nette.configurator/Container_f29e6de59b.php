...
class Container_f29e6de59b extends _PHPStan_5930232b5\Nette\DI\Container
{
	protected $tags = [
	...
	public function createService0364(): PHPStan\File\FileExcluderRawFactory
	{
		return new class ($this) implements PHPStan\File\FileExcluderRawFactory {
			...
			public function __construct(Container_f29e6de59b $container)
			{
	...
	public function createServiceContainer(): Container_f29e6de59b
	{
		return $this;
	}
	...
	protected function getStaticParameters(): array
	{
		return [
			...
			'env' => [
				...
				'SSH_AUTH_SOCK' => '/private/tmp/com.apple.launchd.ihh11RWWAo/Listeners',
