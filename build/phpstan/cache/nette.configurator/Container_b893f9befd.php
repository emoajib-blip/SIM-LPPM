...
class Container_b893f9befd extends _PHPStan_5930232b5\Nette\DI\Container
{
	protected $tags = [
	...
	public function createService0364(): PHPStan\File\FileExcluderRawFactory
	{
		return new class ($this) implements PHPStan\File\FileExcluderRawFactory {
			...
			public function __construct(Container_b893f9befd $container)
			{
	...
	public function createServiceContainer(): Container_b893f9befd
	{
		return $this;
	}
