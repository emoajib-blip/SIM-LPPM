<div class="page page-center">
    <div class="py-4 container-normal container">
        <div class="align-items-center row g-4">
            <div class="col-lg">
                <div class="container-tight">
                    ...
                    <div class="card card-md">
                        <div class="card-body">
                            ...
                            <form method="post" wire:submit.prevent="login" autocomplete="off" novalidate>
                                <div class="mb-3">
                                    <label class="form-label">Email atau ID Identitas</label>
                                    <input type="text" wire:model="email"
                                        class="form-control @error('email') is-invalid @enderror"
                                        placeholder="Email / NIDN / NIK / NIP / NIM" autocomplete="username" autofocus />
                                    @error('email')
                                ...
                                <div class="mb-3">
                                    <label class="form-label">Hayo Berapa {{ $n1 }} + {{ $n2 }}?</label>
                    ...
                    {{-- <div class="mt-3 text-secondary text-center">Don't have account yet? <a href="./sign-up.html" --}}
                    {{-- tabindex="-1">Sign up</a></div> --}}
                </div>
            </div>
            <div class="d-lg-block col-lg d-none">
                <svg class="d-block mx-auto img" xmlns="http://www.w3.org/2000/svg" height="400" fill="none"
                    viewBox="0 0 800 600">
                    <style>
                    ...
                    <path
                        d="M419.427 107.663V130.675C416.293 132.052 413.037 133.134 409.702 133.907C405.104 134.974 400.39 135.454 405.104 134.974C400.39 135.454 395.672 135.337C395.729 130.751 395.782 126.151 395.829 121.536C395.829 116.902 395.929 112.268 395.958 107.692L419.427 107.663Z"
