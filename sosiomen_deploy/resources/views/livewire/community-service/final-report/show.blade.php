    ...
    <x-slot:pageActions>
        <div class="btn-list">
            ...
            @if (auth()->id() === $proposal->submitter_id && (!$progressReport || $progressReport->status->value !== 'approved'))
                <a href="{{ route('community-service.proposal.edit', $proposal) }}" class="btn-outline-warning btn"
            ...
            <div class="card mb-3 border-primary border-2 border-dashed">
                <div class="card-body">
                    ...
                    <div class="steps steps-blue container-tight">
                        <div class="step-item {{ $progressReport->status !== \App\Enums\ReportStatus::DRAFT ? 'active' : '' }}">
                            Dosen (Diajukan)</div>
                        <div
        ...
        <div class="alert alert-warning mb-3" role="alert">
            <div class="d-flex">
                ...
                <div>
                    ...
                    <div class="text-secondary">
                        Pastikan total pengeluaran pada menu Catatan Harian (Logbook) telah mencapai 100% dari total Pagu RAB
                        sebelum mengajukan Laporan Akhir. Sistem akan memblokir pengajuan jika serapan dana belum genap 100%.
                    </div>
                </div>
            </div>
        </div>
...
@endphp
<x-tabler.modal id="modalMandatoryOutput" title="{{ $canEdit ? 'Edit' : 'Lihat' }} {{ $modalMandatoryTitle }}" size="xl"
    scrollable wire:ignore.self onHide="closeMandatoryModal" componentId="{{ $this->getId() }}">
    ...
    <x-slot:body>
        ...
        @if ($form->editingMandatoryId)
            ...
            <div class="row g-3">
                ...
                <!-- BUKU/MODUL Fields -->
                @if (
                        str_contains(strtolower($outputType), 'buku') ||
                ...
                @if (
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="text" wire:model="form.mandatoryOutputs.{{ $form->editingMandatoryId }}.hki_type"
                            class="form-control" placeholder="Paten, Hak Cipta, Merek, dll" @disabled(!$canEdit) />
                    </div>
                    <div class="col-md-6">
                ...
                @if (str_contains(strtolower($outputType), 'media') || str_contains(strtolower($outputGroup), 'media'))
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="date" wire:model="form.mandatoryOutputs.{{ $form->editingMandatoryId }}.publication_date"
                ...
                @if (str_contains(strtolower($outputType), 'video') || str_contains(strtolower($outputGroup), 'video'))
                    ...
                    <div class="col-md-6">
                        ...
                        <select wire:model="form.mandatoryOutputs.{{ $form->editingMandatoryId }}.platform" class="form-select"
                            @disabled(!$canEdit)>
                ...
                @if (
                    ...
                    <div class="col-md-12">
                        ...
                        <input type="text" wire:model="form.mandatoryOutputs.{{ $form->editingMandatoryId }}.product_name"
                            class="form-control" placeholder="Masukkan nama produk/jasa" @disabled(!$canEdit) />
                    </div>
                    <div class="col-md-12">
                        <label class="form-label">Deskripsi Singkat</label>
                        <textarea wire:model="form.mandatoryOutputs.{{ $form->editingMandatoryId }}.description"
                            class="form-control" rows="3" placeholder="Deskripsi produk/jasa" @disabled(!$canEdit)></textarea>
                    </div>
                @endif

                <!-- PEMBERDAYAAN MITRA Fields -->
                @if (
                        str_contains(strtolower($outputType), 'pemberdayaan') ||
                    ...
                    <div class="col-md-12">
                        ...
                        <input type="text" wire:model="form.mandatoryOutputs.{{ $form->editingMandatoryId }}.partner_name"
                            class="form-control" placeholder="Nama kelompok/mitra" @disabled(!$canEdit) />
                    </div>
                    <div class="col-md-6">
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="text" wire:model="form.mandatoryOutputs.{{ $form->editingMandatoryId }}.improvement_value"
                            class="form-control" placeholder="Contoh: 50% atau Rp 10.000.000" @disabled(!$canEdit) />
                    </div>
                    <div class="col-md-12">
                        <label class="form-label">Deskripsi Pencapaian</label>
                        <textarea wire:model="form.mandatoryOutputs.{{ $form->editingMandatoryId }}.description"
                            class="form-control" rows="3" placeholder="Jelaskan peningkatan yang dicapai..."
                ...
                <div class="col-md-3">
                    ...
                    <input type="number" wire:model="form.mandatoryOutputs.{{ $form->editingMandatoryId }}.publication_year"
                ...
                <div class="col-md-12">
                    ...
                    <input type="file" wire:model="tempMandatoryFiles.{{ $form->editingMandatoryId }}" class="form-control"
    ...
    <x-slot:body>
        ...
        @if ($form->editingAdditionalId)
            ...
            <div class="row g-3">
                ...
                <div class="col-md-12">
                    <label class="form-label required">Status</label>
                    <select wire:model="form.additionalOutputs.{{ $form->editingAdditionalId }}.status" class="form-select"
                        @disabled(!$canEdit)>
                        <option value="">Pilih Status</option>
                        <option value="draft">Draft</option>
                        <option value="submitted">Submitted</option>
                ...
                @if (str_contains($outputType, 'buku') || str_contains($outputGroup, 'buku'))
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="text" wire:model="form.additionalOutputs.{{ $form->editingAdditionalId }}.publisher_name"
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="number" wire:model="form.additionalOutputs.{{ $form->editingAdditionalId }}.total_pages"
                ...
                <!-- JURNAL/PROSIDING Fields -->
                @if (
                        str_contains($outputType, 'jurnal') ||
                    ...
                    <div class="col-md-12">
                        ...
                        <input type="text" wire:model="form.additionalOutputs.{{ $form->editingAdditionalId }}.journal_title"
                            class="form-control" placeholder="Masukkan judul" @disabled(!$canEdit) />
                    </div>
                    <div class="col-md-6">
                        <label class="form-label">{{ str_contains($outputType, 'prosiding') ? 'ISBN' : 'ISSN' }}</label>
                    ...
                    <div class="col-md-6">
                        <label class="form-label">Peringkat (Jika Ada)</label>
                        <select wire:model="form.additionalOutputs.{{ $form->editingAdditionalId }}.rank" class="form-select"
                            @disabled(!$canEdit)>
                            <option value="">-- Pilih Peringkat --</option>
                            <optgroup label="SINTA">
                                <option value="S1">S1</option>
