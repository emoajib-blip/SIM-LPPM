    ...
    */
    ...
    'options' => [
        ...
        'gate' => [
            ...
            'timeline' => env('DEBUGBAR_OPTIONS_GATE_TIMELINE', false),      // Add gates to the timeline
        ],
        'db' => [
        ...
        'cache' => [
            ...
            'timeline' => env('DEBUGBAR_OPTIONS_CACHE_TIMELINE', false),  // Add cache to the timeline
        ],
        'http_client' => [
            'masked' => [],
